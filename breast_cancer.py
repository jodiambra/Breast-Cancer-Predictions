...
with col1:
    ...
    radius_mean = st.slider('Radius Mean', 6.0, 30.0, step=0.5, value=random.radint(6, 30))
    texture_mean = st.slider('Texture Mean', 9.0, 40.0, step=0.5, value=random.radint(9, 40))
    perimeter_mean = st.slider('Perimeter Mean', 43, 190, step=1, value=random.radint(43, 190))
    area_mean = st.slider('Area Mean', 143, 2550, step=50, value=random.radint(143, 2550))
...
with col2:
    ...
    area_se = st.slider('Area Standard Error', 6, 546, step=15, value=random.radint(6, 546))
...
with col3:
    ...
    texture_worst = st.slider('Texture Worst Value', 12.0, 50.0, step=2.0, value=random.radint(12, 50))
    perimeter_worst = st.slider('Perimeter Worst Value', 50.0, 256.0, step=5.0, value=random.radint(50.0, 256.0))
    area_worst = st.slider('Area Worst Value', 185, 4255, step=75, value=random.radint(185, 4225))

...
with col1:
    ...
    texture_mean = st.slider('Texture Mean', 9.0, 41.0, step=0.5)
    perimeter_mean = st.slider('Perimeter Mean', 43, 190, step=1)
    area_mean = st.slider('Area Mean', 143, 2550, step=50)
    smoothness_mean = st.slider('Smoothness Mean', 0.05, .21, step=0.05)
    ...
    concave_points_mean = st.slider('Concave Points Mean', 0.00, 0.21, step=0.05)
    symmetry_mean = st.slider('Symmetry Mean', 0.1, 0.31, step=0.05)
...
with col2:
    ...
    compactness_se = st.slider('Compactness Standard Error', 0.000, 0.13, step=0.005)
    concavity_se = st.slider('Concavity Standard Error', 0.000, 0.40, step=0.05)
    concave_points_se = st.slider('Concave Points Standard Error', 0.000, 0.056, step=0.005)
...
with col3:
    ...
    radius_worst = st.slider('Radius Worst Value', 7.5, 36.6, step=1.0)
    ...
    compactness_worst = st.slider('Compactness Worst Value', 0.025, 1.11, step=0.05)
    concavity_worst = st.slider('Concavity Worst Value', 0.000, 1.26, step=0.05)
    concave_points_worst = st.slider('Concave Points Worst Value', 0.000, 0.30, step=0.005)
    symmetry_worst = st.slider('Symmetry Worst Value', 0.15, 0.71, step=0.10)
    fractal_dimension_worst = st.slider('Fractal Dimension Worst Value', 0.0055, 0.21, step=0.05)

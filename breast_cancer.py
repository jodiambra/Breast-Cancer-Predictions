...
with col1:
    ...
    radius_mean = st.slider('Radius Mean', 6.0, 30.0, step=0.5, value=random.randint(6, 30))
    texture_mean = st.slider('Texture Mean', 9.0, 40.0, step=0.5, value=random.randint(9, 40))
...
with col3:
    ...
    texture_worst = st.slider('Texture Worst Value', 12.0, 50.0, step=2.0, value=random.randint(12, 50))
    perimeter_worst = st.slider('Perimeter Worst Value', 50.0, 256.0, step=5.0, value=random.randint(50.0, 256.0))
